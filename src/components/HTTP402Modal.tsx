...
export default function HTTP402Modal({ asset, userKey, onClose, onSuccess }: HTTP402ModalProps) {
  ...
  async function createPaymentScript(recipientKey: string): Promise<string> {
    ...
    // This is a simplified version - production would use proper BRC standards
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-purple-200 text-sm">Pay to unlock rental details</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-purple-600">{asset.unlockFee} BSV</span>
                </div>
          ...
          {step === 'paying' && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">Creating BSV transaction...</p>
            </div>
          )}
          ...
          {step === 'verifying' && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">Confirming transaction on BSV network...</p>
