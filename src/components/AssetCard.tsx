...
const categoryIcons: Record<string, JSX.Element> = {
  ...
  staycations: (
    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 20h18M4 18a6 6 0 0116 0M12 4l3 6H9l3-6zm0 0V3" />
    </svg>
  ),
  photography: (
    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const categories = [
  ...
  { id: 'staycations', name: 'Staycations & Short-Term Rentals' },
